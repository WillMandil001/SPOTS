...
model_save_path = "/home/user/Robotics/SPOTS/models/SVTG_auto_enc_amir/saved_models/PRI_single_object_purple_"
            ...
            if previous_val_mean_loss < val_mae_losses / index__:
                ...
                if best_val_loss > val_mae_losses / index__:
                    ...
                    torch.save({'encoder_tactile': self.encoder_tactile, 'decoder_tactile': self.decoder_tactile, 'encoder_scene': self.encoder_scene, 'decoder_scene': self.decoder_scene,
                                'frame_predictor': self.frame_predictor, 'posterior': self.posterior, 'prior': self.prior, 'MMFM': self.MMFM, 'features': features}, model_save_path + "SVG_model")
