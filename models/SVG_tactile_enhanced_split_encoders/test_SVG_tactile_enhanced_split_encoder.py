...
model_path      = "/home/user/Robotics/SPOTS/models/SVG_tactile_enhanced_split_encoders/saved_models/PRI_single_object_purple_SVTG_SEmodel_17_02_2022_11_41/SVTG_SE_model"
data_save_path  = "/home/user/Robotics/SPOTS/models/SVG_tactile_enhanced_split_encoders/saved_models/PRI_single_object_purple_SVTG_SEmodel_17_02_2022_11_41/"
        ...
        for trial in self.number_of_trials:
            ...
            for index, batch_features in enumerate(self.test_full_loader):
                if batch_features[1].shape[0] == batch_size:
                    ...
                    mae, mae_tact, kld, predictions = self.run(scene=images, touch=tactile, actions=action, test=True)

                    for i in range(10):
                        plt.figure(1)
                        f, axarr = plt.subplots(1, 2)
                        axarr[0].set_title("SVTG_split_encs pred: t_" + str(i))
