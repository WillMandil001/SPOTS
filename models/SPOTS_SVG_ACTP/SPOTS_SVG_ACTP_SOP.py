...
model_save_path = "/home/user/Robotics/SPOTS/models/SPOTS_SVG_ACTP/saved_models/PRI_single_object_purple_SPOTS_SVG_ACTP_SOP"
...
class ModelTrainer:
    def __init__(self):
        ...
        import ACTP_model
        self.tactile_frame_predictor = ACTP_model.ACTP()
        self.tactile_frame_predictor.apply(utils.init_weights)
        ...
        self.tactile_frame_predictor_optimizer = self.optimizer(self.tactile_frame_predictor.parameters(), lr=lr, betas=(beta1, 0.999))
        ...
        self.tactile_frame_predictor.cuda()
