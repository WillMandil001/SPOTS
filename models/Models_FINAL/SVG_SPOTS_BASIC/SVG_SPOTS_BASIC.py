...
model_save_path = "/home/wmandil/Robotics/SPOTS/SPOTS/models/SVG-SPOTS/saved_models/PRI_single_object_purple_SVG_SPOTS_BASIC_"
...
training_stages = ["everything"]
training_stages_epochs = [100]
lr=0.0001
beta1=0.9
batch_size=32
log_dir='logs/lp'
    ...
    def train_full_model(self):
        ...
        for stage, epoch_len in zip(training_stages, training_stages_epochs):
                ...
                if previous_val_mean_loss < val_mae_losses_scene / index__:
                    ...
                    if best_val_loss > val_mae_losses_scene / index__:
                        ...
                        torch.save({"frame_predictor_tactile": self.frame_predictor_tactile, "encoder_tactile": self.encoder_tactile, "decoder_tactile": self.decoder_tactile,
                                    ...
                                    "posterior": self.posterior, "prior": self.prior, 'features': features}, model_save_path + "SVG_SPOTS_BASIC_BEST")
            ...
            if stage == "scene_only":
                torch.save({"frame_predictor_tactile": self.frame_predictor_tactile, "encoder_tactile": self.encoder_tactile,"decoder_tactile": self.decoder_tactile,
                            "frame_predictor_scene": self.frame_predictor_scene, "encoder_scene": self.encoder_scene, "decoder_scene": self.decoder_scene,
                            "posterior": self.posterior, "prior": self.prior, 'features': features}, model_save_path + "SVG_SPOTS_3S_SOP_stage1")
            elif stage == "tactile_loss_plus_scene_fixed":
                torch.save({"frame_predictor_tactile": self.frame_predictor_tactile, "encoder_tactile": self.encoder_tactile,"decoder_tactile": self.decoder_tactile,
                            "frame_predictor_scene": self.frame_predictor_scene, "encoder_scene": self.encoder_scene, "decoder_scene": self.decoder_scene,
                            "posterior": self.posterior, "prior": self.prior, 'features': features}, model_save_path + "SVG_SPOTS_3S_SOP_stage2")
            elif stage == "scene_loss_plus_tactile_gradual_increase":
                torch.save({"frame_predictor_tactile": self.frame_predictor_tactile, "encoder_tactile": self.encoder_tactile,"decoder_tactile": self.decoder_tactile,
                            "frame_predictor_scene": self.frame_predictor_scene, "encoder_scene": self.encoder_scene, "decoder_scene": self.decoder_scene,
                            "posterior": self.posterior, "prior": self.prior, 'features': features}, model_save_path + "SVG_SPOTS_3S_SOP_stage3")
