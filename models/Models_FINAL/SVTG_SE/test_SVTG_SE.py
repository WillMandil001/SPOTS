...
model_path      = "/home/wmandil/Robotics/SPOTS/SPOTS/models/SVG-SPOTS/saved_models/PRI_single_object_purple_SVTG_SEmodel_03_03_2022_14_24/SVTG_SE_model"
data_save_path  = "/home/wmandil/Robotics/SPOTS/SPOTS/models/SVG-SPOTS/saved_models/PRI_single_object_purple_SVTG_SEmodel_03_03_2022_14_24/"
test_data_dir   = "/home/wmandil/Robotics/Data_sets/PRI/single_object_purple/single_object_purple_formatted/test_novel_formatted/"
...
class ModelTester:
    ...
    def test_full_model(self):
        ...
        for trial in self.number_of_trials:
            ...
            #             axarr[0].set_title("SVTG_SE pred: t_" + str(i))
        ...
        np.save(data_save_path + "t10test_novel_losses_per_trial", np.array(self.total_losses))
        
        print(self.total_losses)
        
        final_loss = sum([i[1] for i in self.total_losses]) / len(self.total_losses)
        
        np.save(data_save_path + "t10test_novel_loss", np.array(final_loss))
