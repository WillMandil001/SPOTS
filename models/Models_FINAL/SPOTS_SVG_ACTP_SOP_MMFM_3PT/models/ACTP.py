...
class ACTP(nn.Module):
    ...
    def init_hidden(self, batch_size):
        self.hidden1 = (torch.zeros(1, batch_size, 400, device=torch.device('cuda')), torch.zeros(1, batch_size, 400, device=torch.device('cuda')))
        self.hidden2 = (torch.zeros(1, batch_size, 400, device=torch.device('cuda')), torch.zeros(1, batch_size, 400, device=torch.device('cuda')))
